          ...
          <div className="w-full max-w-[1440px] mx-auto flex flex-col md:grid md:grid-cols-2 lg:flex lg:flex-row gap-6 lg:gap-10 px-4 sm:px-6 md:px-12">
            ...
            <div className="flex flex-col gap-4 flex-1">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                <Link href="https://apps.apple.com/co/app/encriptados/id6661017242" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity"><Image src="/images/footer/app-store.svg" alt="App Store" width={116} height={35} className="h-8 md:h-7 lg:h-9 w-auto" /></Link>
                <Link href="https://play.google.com/store/apps/details?id=io.encriptados.app&hl=es_CO" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity"><Image src="/images/footer/google-play.svg" alt="Google Play" width={119} height={35} className="h-8 md:h-7 lg:h-9 w-auto" /></Link>
                <Link href="https://apk.encriptados.io/Encriptados.apk" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity"><Image src="/images/footer/apk.svg" alt="Descargar APK" width={119} height={35} className="h-8 md:h-7 lg:h-9 w-auto" /></Link>
              </div>
            </div>
