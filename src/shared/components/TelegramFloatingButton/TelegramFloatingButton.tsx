  ...
  return (
    ...
    >
      <div className="flex items-center justify-center w-full h-full">
        ...
        {/* Texto CHATEAR */}
        <span className={`font-semibold text-sm md:font-extrabold md:text-lg lg:text-base md:tracking-wider text-white font-sans transition-all duration-500 overflow-hidden whitespace-nowrap ${
