...
const PurchaseHeader: React.FC<Props> = ({
  ...
  return (
    <div className="w-full">
      ...
      <div className="mt-3 sm:mt-4 flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-5">
        {/* Izquierda: imagen */}
        <div
          className="
            ...
            <div className="grid grid-cols-[auto,1fr] items-center gap-x-3 sm:gap-x-4">
              ...
              >
                <button
                  ...
                  className="group w-[80px] h-[36px] rounded-[8px] bg-[#EBEBEB]
                ...
                >
                  ...
                  {openLicense && (
                    ...
                    >
                      {normVariants.map((v) => {
                        const isActive =
                          (selectedVariantId ?? normVariants[0]?.id) === v.id;
                        return (
                          <button
                            key={v.id}
                            role="option"
