...
const SecureMdmSims = () => {
  const t = useTranslations("SecureMdmPage.simOptionsSecureMdm");
  ...
  const images = [
    "/images/apps/secure-mdm-android/SIM-Card-encriptada.png",
    "/images/apps/secure-mdm-android/E-SIM-Card-encriptada.png"
  ];
