...
const UltraxSims = () => {
  const t = useTranslations("UltraxPage.simOptionsUltrax");
  ...
  const images = [
    "/images/apps/ultrax/SIM-Card-encriptada.png",
    "/images/apps/ultrax/E-SIM-Card-encriptada.png"
  ];
