...
const FeaturedProductsTablet: React.FC<FeaturedProductsTabletProps> = ({
  ...
  <section className="w-full hidden sm:flex lg:hidden justify-center py-8 mt-[30px]">
    <div className="flex flex-col gap-6 w-full max-w-[718px] px-6">
      {" "}
      {/* 349*2 + gap */}
      {/* LEFT CARD */}
      <div
      ...
      >
        ...
        <img
          ...
          className="absolute right-0 bottom-0 max-w-[300px] max-h-[90%] w-auto h-auto object-contain object-bottom select-none pointer-events-none"
          draggable={false}
        />
      </div>
      {/* RIGHT CARD */}
