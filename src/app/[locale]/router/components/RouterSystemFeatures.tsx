...
const CryptcomSystemFeatures = () => {
  const t = useTranslations("CryptcomPage.systemFeatures");
  ...
  return (
    <section className="relative overflow-hidden py-20 px-4">
      ...
      <div className="max-w-7xl mx-auto text-center justify-items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:max-w-[740px]">
...
export default CryptcomSystemFeatures;
