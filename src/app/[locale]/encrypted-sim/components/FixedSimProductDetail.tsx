...
const FixedSimProductDetail: React.FC = () => {
  ...
  const commonFeaturesData = [
    { icon: CharacteristicDatasSvg, alt: t("commonFeatures.dataMobile"), description: t("commonFeatures.dataMobile") },
    { icon: CharacteristicSpeedSvg, alt: t("commonFeatures.speed"), description: t("commonFeatures.speed") },
    { icon: CharacteristicAppSvg, alt: t("commonFeatures.appAvailable"), description: t("commonFeatures.appAvailable") },
  ];

  const commonFeaturesMinutes = [
    { icon: CharacteristicAnonimitySvg, alt: t("commonFeatures.privacyAnonymity"), description: t("commonFeatures.privacyAnonymity") },
    { icon: CharacteristicReplaceSvg, alt: t("commonFeatures.substituteNumber"), description: t("commonFeatures.substituteNumber") },
    { icon: CharacteristicVoiceSvg, alt: t("commonFeatures.callback"), description: t("commonFeatures.callback") },
    { icon: CharacteristicVoiceSvg, alt: t("commonFeatures.voiceFilters"), description: t("commonFeatures.voiceFilters") },
    { icon: CharacteristicAppSvg, alt: t("commonFeatures.appAvailable"), description: t("commonFeatures.appAvailable") },
  ];

  const commonFeaturesImsi = [
    { icon: CharacteristicAnonimitySvg, alt: t("commonFeatures.privacyAnonymity"), description: t("commonFeatures.privacyAnonymity") },
    { icon: CharacteristicComunicationsSvg, alt: t("commonFeatures.encryptedCommunications"), description: t("commonFeatures.encryptedCommunications") },
    { icon: CharacteristicReplaceSvg, alt: t("commonFeatures.replaceIMSI"), description: t("commonFeatures.replaceIMSI") },
    { icon: CharacteristicAppSvg, alt: t("commonFeatures.appAvailable"), description: t("commonFeatures.appAvailable") },
  ];

  const commonFeaturesEsim = [
    { icon: CharacteristicAnonimitySvg, alt: t("commonFeatures.privacyAnonymity"), description: t("commonFeatures.privacyAnonymity") },
    { icon: CharacteristicTopUpSvg, alt: t("commonFeatures.unlimitedDataPlans"), description: t("commonFeatures.unlimitedDataPlans") },
    { icon: CharacteristicComunicationsSvg, alt: t("commonFeatures.encryptedCommunications"), description: t("commonFeatures.encryptedCommunications") },
    { icon: CharacteristicAppSvg, alt: t("commonFeatures.appAvailable"), description: t("commonFeatures.appAvailable") },
  ];
  ...
  const filtered = cardData.filter(card => card.id.toString() === selectedId);
  ...
  return (
    <div className="flex flex-col gap-5">
      {filtered.map((card, index) => (
        <div
          key={index}
          className="bg-custom-linear sm:!bg-transparent shadow-lg sm:shadow-none gap-6 flex flex-col sm:flex-row my-0 rounded-3xl sm:p-0 ls:p-0 p-4 py-10 sm:py-0 ls:py-0"
        >
