                    ...
                    <div className="space-y-8 bg-bg-secondary/30 p-8 md:p-12 rounded-2xl border border-stroke-border/30 backdrop-blur-sm">
                        ...
                        <div className="space-y-6 text-sm md:text-base leading-relaxed">
                            ...
                            <section className="space-y-4">
                                ...
                                <p>
                                    Si desea expresar una queja verbal sobre la celebración del contrato o su cumplimiento, puede enviar un su petición al correo electrónico: <a href="mailto:contacto@encriptados.io" className="text-primary hover:underline">contacto@encriptados.io</a>
                                </p>
                            </section>
                            ...
                            <section className="space-y-4">
                                ...
                                <p>
                                    De igual modo, en caso de que cualquier Usuario o un tercero consideren que alguno de los contenidos de la Web propiedad de SAFESOLF vulneran sus derechos de propiedad intelectual y/o industrial, así como cualesquiera otros derechos, deberán remitir una comunicación a <a href="mailto:contacto@encriptados.io" className="text-primary hover:underline">contacto@encriptados.io</a> con la documentación necesaria que acredite tal extremo, y desde SAFESOLF se dará cumplida respuesta tan pronto como sea posible.
                                </p>
                                <p>
