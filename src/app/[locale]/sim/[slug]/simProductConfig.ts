...
export const simProductConfigs: Record<string, SimProductStaticConfig> = {
  ...
  "tim-sim": {
    ...
    heroBanners: {
      ...
      tablet: "/images/bne-sim/anonymous-tablet.webp",
      mobile: "/images/bne-sim/anonymous-movil.webp",
    },
    productImage: "/images/bne-sim/hombre-feliz.webp",
    iconUrl: "/images/bne-sim/logo-tim.webp",
