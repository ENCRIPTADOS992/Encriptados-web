...
const SilentCircleBanner = () => {
    ...
    <div className="
        ...
        py-8 rounded-3xl bg-[#101010] text-white
      ">
      ...
      {/* Contenido */}
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-start md:justify-between gap-6 md:gap-10 left-0 md:left-10">
        {/* Texto */}
        <div className="w-full md:w-1/2 md:ml-14 mx-auto md:mx-0 text-center md:text-left space-y-4">
          ...
          <p className="text-sm text-gray-300 max-w-md mx-auto md:mx-0">
            Desarrollada por expertos en tecnología móvil, esta app protege tus datos
            con máxima seguridad en todo momento.
          </p>
        </div>

        {/* Card */}
        {silentProduct && (
          <div className="w-full md:w-2/5 flex justify-center md:justify-end mt-6 md:mt-0 mr-0 md:mr-40">
            <div className="w-full max-w-sm mx-auto md:mx-0">
              <CardProductItem
                key={silentProduct.id}
