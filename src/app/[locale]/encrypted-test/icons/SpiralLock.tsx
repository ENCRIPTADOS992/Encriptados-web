...
const SpiralLock: React.FC<SpiralLockProps> = ({ onTestInit }) => {
  ...
  return (
    <div className="relative flex items-center justify-center w-[170px] sm:w-[260px] lg:w-[320px] h-[170px] sm:h-[260px] lg:h-[320px]">
      <svg
      ...
      >
        <circle cx="236" cy="236" r="149.5" stroke={`url(#paint0_linear_${uniqueId})`} />
        <circle cx="236" cy="236" r="235.5" stroke={`url(#paint1_linear_${uniqueId})`} />
        <mask id={`mask0_0_1_${uniqueId}`} maskUnits="userSpaceOnUse" x="167" y="167" width="138" height="138">
          <rect x="167" y="167" width="138" height="138" fill="#D9D9D9" />
        </mask>
        <g mask={`url(#mask0_0_1_${uniqueId})`}>
          <path
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 -ml-[100px] z-10">
